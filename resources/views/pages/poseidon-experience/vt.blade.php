...
<!-- Mirrored from poseidonnhatranghotel.com/poseidon-experience/location by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:30:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('explocation.title') }} | Poseidon Nha Trang hotel</title>
            ...
            <div class="container contents">
                ...
                <div class="row">
                        <div class="room-title col-sm-12 mb20">
                            <h3> {!!html_entity_decode(__('explocation.title'))!!}</h3>
                        </div>
                        <div class="col-sm-4"><img style="width:100%" src="{{asset('img/')}}/{{$rows->photo}}" alt="" class="mCS_img_loaded">
