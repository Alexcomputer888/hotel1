...
<head>
    ...
    <title>Gallery | Poseidon Nha Trang hotel</title>
                    ...
                    <div class="col-sm-4 mb20">
                        <a href="/galleries/receptions">
                            <div class="block-contain">
                                ...
                                <h4 style="color:#4F2D55">Receptions</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb20">
                        <a href="/galleries/accommodations">
                            <div class="block-contain">
                                <img src="Upload/files/1211.jpg" class="img-responsive">
                                <h4 style="color:#4F2D55">Accommodations</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb20">
                        <a href="/galleries/restaurant">
                            <div class="block-contain">
                                <img src="Upload/files/1A.jpg" class="img-responsive">
                                <h4 style="color:#4F2D55">Restaurant</h4>
                            </div>
                        </a>
                    </div>
