...
<!-- Mirrored from poseidonnhatranghotel.com/poseidon-experience/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:30:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('expaboutus.title') }} | Poseidon Nha Trang hotel</title>
    ...
    <div class="background-home" style="">
        <div id="slides">
                <div class="slides-container">
                       <img style="width:100%" src="{{asset('img/').$rows->phoo}}" alt="" class="mCS_img_loaded">
            ...
            <div class="container contents">
                ...
                <div class="row">
                        <div class="room-title col-sm-12 mb20">
                            <h3>{!!html_entity_decode(__('expaboutus.title'))!!}</h3>
                        </div>
                        <div class="col-sm-4">
                        <img style="width:100%" src="{{asset('img/z3445949308255_0b4c7d08b1e047ca88557546a0888e87.jpg')}}" alt="">
