...
<!-- Mirrored from poseidonnhatranghotel.com/poseidon-service/quay-dich-vu-van-phong by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:33:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('sevice5.title') }} | Poseidon Nha Trang hotel</title>
            ...
            <div class="container contents">
                ...
                <div class="row">
                        <div class="room-title col-sm-12 mb20">
                            <h3>{!!html_entity_decode(__('sevice5.title'))!!}</h3>
                        </div>
                        <div class="col-sm-4">
                                <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                <li data-thumb="{{ asset('img/m1.jpg')}}" class="lslide" style="width: 260px; margin-right: 0px;">
                                            <img src="{{ asset('img/m1.jpg')}}" class="img-responsive mCS_img_loaded">
                                        </li>
                                        <li data-thumb="{{ asset('img/m2.jpg')}}" class="lslide active" style="width: 260px; margin-right: 0px;">
                                            <img src="{{ asset('img/m2.jpg')}}" class="img-responsive mCS_img_loaded">
                                        </li>
                                        <li data-thumb="{{ asset('img/m3.jpg')}}" class="lslide active" style="width: 260px; margin-right: 0px;">
                                            <img src="{{ asset('img/m3.jpg')}}" class="img-responsive mCS_img_loaded">
                                        </li>
                                </ul>

                        </div>
                        <div class="col-sm-8 meeting-content">
                            {!!html_entity_decode(__('sevice5.content'))!!}
                        </div>
